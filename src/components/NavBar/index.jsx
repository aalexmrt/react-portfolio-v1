...
export const NavBar = ({ navSections }) => {
  ...
  return (
    ...
    <nav className='flex md:grid md:grid-cols-3 justify-between items-center navbar px-8 md:px-0 md:mx-16 text-[0.8em] '>
      ...
      <ul className="md:flex md:justify-between justify-self-center md:gap-4 p-1 md:px-5 font-medium nav md:bg-[#fffcfc] md:border-2 rounded-full shadow-sm drop-shadow-sm">
        {navSections
      ...
      <div className='hidden md:flex text-[30px] gap-3 flex-row justify-self-end align-center justify-center items-center decoration-none  hover:text-bold '>
