  ...
  return (
    <section className="about-me">
      ...
      <p className="md:text-1xl text-lg lg:text-2xl">
        ...
        <br></br>
        who loves making beautiful and user-friendly websites. I{"'"}m really
        into <strong>front-end development</strong>, where I turn ideas into
        cool digital experiences. I find the world of web tech fascinating. It
        lets me <strong>create smooth websites</strong>, make them faster, and
        solve tricky coding puzzles. I get a kick out of{" "}
        <strong>making the web better</strong>, project by project. I think the
        best websites are both functional and gorgeous. I work hard to blend
        technical skills with a good eye for design, so every pixel and line of
        code looks just right. My focus is on{" "}
