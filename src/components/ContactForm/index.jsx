...
export const ContactForm = () => {
  ...
  return (
    <section id="contact" className="grid gap-1 mx-8 md:mx-16 mt-[4.3rem]">
      ...
      <h1 className='font-bold text-5xl tracking-tighter mt-8'>
        Contact
      </h1>
      <p className="text-lg mt-6">Feel free to get in touch with me using this contact form or reaching out by LinkedIn.
      </p>

      <form className="mt-8" ref={form} onSubmit={sendEmail}>
        <div className="mb-5">
          <label htmlFor="name" className="mb-3 block text-base font-semibold text-[#07074D]">
                    Full Name
          </label>
        ...
        {/* <div className="mb-5">
            <label htmlFor="subject" className="mb-3 block text-base font-semibold text-[#07074D]">
                    Subject
            </label>
        ...
        <div className="mb-5">
          <label htmlFor="message" className="mb-3 block text-base font-semibold text-[#07074D]">
                    Message
          </label>
          <textarea rows="4" name="message" id="message" placeholder="Type your message"
            className="w-full resize-none rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-semibold text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md"></textarea>
        </div>
        <div>
          <button
